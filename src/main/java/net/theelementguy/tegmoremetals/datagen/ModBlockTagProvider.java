...
public class ModBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        valueLookupBuilder(ConventionalBlockTags.ORES).add(ModBlocks.CUBIC_ZIRCONIA_ORE).add(ModBlocks.DEEPSLATE_CUBIC_ZIRCONIA_ORE).add(ModBlocks.NETHER_RUBIDIUM_ORE).add(ModBlocks.END_STARSHARD_ORE).add(ModBlocks.BLOODSTONE_ORE).add(ModBlocks.DEEPSLATE_BLOODSTONE_ORE);

        valueLookupBuilder(ConventionalBlockTags.ORES_IN_GROUND_STONE).add(ModBlocks.CUBIC_ZIRCONIA_ORE).add(ModBlocks.BLOODSTONE_ORE);

        valueLookupBuilder(ConventionalBlockTags.ORES_IN_GROUND_DEEPSLATE).add(ModBlocks.DEEPSLATE_CUBIC_ZIRCONIA_ORE).add(ModBlocks.DEEPSLATE_BLOODSTONE_ORE);

        valueLookupBuilder(ConventionalBlockTags.ORES_IN_GROUND_NETHERRACK).add(ModBlocks.NETHER_RUBIDIUM_ORE);

        valueLookupBuilder(ConventionalBlockTags.STORAGE_BLOCKS).add(ModBlocks.CUBIC_ZIRCONIA_BLOCK).add(ModBlocks.RUBIDIUM_BLOCK).add(ModBlocks.STARSHARD_BLOCK).add(ModBlocks.BLOODSTONE_BLOCK);
